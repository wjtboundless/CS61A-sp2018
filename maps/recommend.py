...
def group_by_centroid(restaurants, centroids):
    ...
    for r in restaurants:
        pair.append([find_closest(restaurant_location(r), centroids), r]) 
...
def find_centroid(cluster):
    ...
    for c in cluster:
        latitude, longitude = [], []
        for r in c:
            latitude.append(restaurant_location(r)[0])
            longitude.append(restaurant_location(r)[1])
        new_centr.append([mean(latitude), mean(longitude)])
    return new_centr
    # END Question 5
