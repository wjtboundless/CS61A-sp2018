...
def read(s):
    """Parse an expression from a string and return input expression represented
     as an instance of a subclass of Expr. If the string does not contain an
...
def read_expr(src):
    ...
    return: an instance of a subclass of Expr
    """
