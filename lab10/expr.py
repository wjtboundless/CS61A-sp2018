...
class LambdaFunction(Value):
    """A lambda function is a lambda expression that knows the
    environment in which it was evaluated in. Lambda functions 
    are created in the LambdaExpr.eval method. 
    ...
    def apply(self, arguments):
        ...
        if len(self.parameters) != len(arguments):
            ...
            for parameter, argument in zip(self.parameters, arguments):
                new_parent[parameter] = argument
            return self.body.eval(new_parent)
